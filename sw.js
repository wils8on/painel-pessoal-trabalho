const CACHE = "dossie-v11.2";
const APP_SHELL = ["./", "./index.html", "./css/style.css", "./js/app.js", "./js/core-utils.js", "./js/firebase-config.js", "./js/cloudinary-config.js", "./manifest.webmanifest", "./icon.svg"];
